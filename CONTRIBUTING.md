Contributing to Felycoin Core
============================

The Felycoin Core project operates an open contributor model where anyone is
welcome to contribute towards development in the form of peer review, testing
and patches. This document explains the practical process and guidelines for
contributing.

First, in terms of structure, there is no particular concept of "Felycoin Core
...
Felycoin Core and how to run the unit tests, functional tests, and fuzz tests.

There are many open issues of varying difficulty waiting to be fixed.
If you're looking for somewhere to start contributing, check out the
[good first issue](https://github.com/felycoin/felycoin/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
list or changes that are
[up for grabs](https://github.com/felycoin/felycoin/issues?utf8=%E2%9C%93&q=label%3A%22Up+for+grabs%22).
Some of them might no longer be applicable. So if you are interested, but
unsure, you might want to leave a comment on the issue first.

You may also participate in the weekly
[Bitcoin Core PR Review Club](https://felycoincore.reviews/) meeting.
...
`#felycoin-core-dev` channel on Libera Chat. The easiest way to participate on IRC is
with the web client, [web.libera.chat](https://web.libera.chat/#felycoin-core-dev). Chat
history logs can be found
on [https://www.erisian.com.au/felycoin-core-dev/](https://www.erisian.com.au/felycoin-core-dev/)
and [https://gnusha.org/felycoin-core-dev/](https://gnusha.org/felycoin-core-dev/).

Discussion about codebase improvements happens in GitHub issues and pull
requests.

The developer
[mailing list](https://groups.google.com/g/felycoindev)
should be used to discuss complicated or controversial consensus or P2P protocol changes before working on
a patch set.
Archives can be found on [https://gnusha.org/pi/felycoindev/](https://gnusha.org/pi/felycoindev/).
...
For GUI-related issues or pull requests, the https://github.com/felycoin-core/gui repository should be used.
For all other issues and pull requests, the https://github.com/felycoin/felycoin node repository should be used.
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to felycoin-qt
...
[Translation Process](https://github.com/felycoin/felycoin/blob/master/doc/translation_process.md)
...
When a pull request conflicts with the target branch, you may be asked to rebase it on top of the current target branch.
    ...
    git fetch https://github.com/felycoin/felycoin  # Fetch the latest upstream commit
...
https://github.com/felycoin/felycoin/pull/16189).

Also see the [backport.py script](
https://github.com/felycoin-core/felycoin-maintainer-tools#backport).
